...
To test how well this package can translate NONMEM models a separate
repository is available
[here](https://github.com/RichardHooijmaijers/amp.sim.test). In here
dozens of models from the ddmore repository are tested. This test
indicate that almost all translations are successful. The main reason
some models could not be fully translated is mainly caused by a subtle
difference in model syntax which can be fixed quite easily.
